...
export const useInitService = (url: string, ip?: string) => {
	const finalIp = ip ?? ipNhanSu;
	...
	const postValidateImport = (payload: any, params: Record<any, any> = {}) => {
		return axios.post(`${finalIp}/${url}/import/validate`, payload, { params });
	};

	const postExecuteImport = (payload: any, params: Record<any, any> = {}) => {
		return axios.post(`${finalIp}/${url}/import/insert`, payload, { params });
	};
